...
module.exports = (app) => {
   ...
   * @extends {app.Service}
   */
  class Printer extends app.Service {
    /**
     * 生成签名sign
     ...
     * @memberof Printer
     */
    print(partner, machine_code, content, apiKey, msign) {
      $param = array(
        "partner"=>$partner,
     ...
     * @memberof Printer
     */
    addprint(partner, machine_code, username, printname, mobilephone, apiKey, msign) {
      $param = array(
        'partner'=>$partner,
        'machine_code'=>$machine_code,
        'username'=>$username,
     ...
     * @memberof Printer
     */
    removeprinter(partner, machine_code, apiKey, msign) {
      $param = array(
        'partner'=>$partner,
        'machine_code'=>$machine_code,
        );
